...
<CardGroup cols={2}>
  <Card title="Quick Setup" icon="zap" href="/quickstart#quick-setup-github-copilotcursor" color="#10b981">
  ...
  <Card title="Full Setup" icon="list" href="/quickstart#full-setup-claude-codeother-ais" color="#f59e0b">
