...
<CardGroup cols={2}>
  <Card title="Quick Setup" icon="zap" href="#quick-setup-github-copilotcursor">
    **GitHub Copilot or Cursor:**

    1 step - Just install the extension!
  </Card>

  <Card title="Full Setup" icon="list" href="#full-setup-claude-codeother-ais">
...
- **Join the community** - [GitHub Discussions](https://github.com/withpointbreak/pointbreak/discussions)
